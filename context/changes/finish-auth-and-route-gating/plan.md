...
- [x] 2.1 Linting passes: `pnpm lint` — 8c1ab2e
- [x] 2.2 Build passes: `pnpm build` — 8c1ab2e
- [x] 2.3 Sign-in/sign-up validate form data before Supabase and explicitly export `prerender = false` — 8c1ab2e
