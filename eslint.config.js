...
export default tseslint.config(
  ...
  {
    // Generated by `supabase gen types typescript` — its generic helper types
    // trip strict rules (e.g. no-redundant-type-constituents) that would just
    // recur on every regeneration; never hand-edit this file anyway.
    ignores: [".claude/**", "src/lib/database.types.ts"],
  },
  baseConfig,
  reactConfig,
